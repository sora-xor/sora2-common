...
impl Default for Validator {
    ...
    fn default() -> Self {
        Self {
            ...
            activation_eligibility_epoch: Epoch::from(core::u64::MAX),
            activation_epoch: Epoch::from(core::u64::MAX),
            exit_epoch: Epoch::from(core::u64::MAX),
            withdrawable_epoch: Epoch::from(core::u64::MAX),
            slashed: false,
            effective_balance: core::u64::MAX,
        }
    }
}
