# AGENTS: beefy-light-client-rpc

Quick guide for contributors and AI coding agents working in this crate.

## Scope
JSON-RPC glue for the beefy-light-client runtime API. See `Cargo.toml` for details.
...
- Test (this crate): `cargo test -p beefy-light-client-rpc --features runtime-benchmarks`
